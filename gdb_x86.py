...
oldregister = { 'eax' : '0', 'ecx' : '0', 'edx' : '0', 'ebx' : '0', 'esp' : '0', 'ebp' : '0',
		'esi' : '0', 'edi' : '0', 'eip' : '0', 'eflags' : '0'}
...
def asmview(isInternal, Adres):
	...
	if isInternal == 0:
		...
		newAddress = hex(int(oldregister['eip'],16)-30)
